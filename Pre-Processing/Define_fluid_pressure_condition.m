...
function Model=Define_fluid_pressure_condition(Model,FID,varargin)
%==========================Check input=====================================
...
%========================main function=====================================
Model.Fluid_pressure_condition(FID,1).type=type;
Model.Fluid_pressure_condition(FID,1).set=set(:);
Model.Fluid_pressure_condition(FID,1).value=value(:);
Model.Fluid_pressure_condition(FID,1).expression=expression(:);
end