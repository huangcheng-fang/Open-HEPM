...
function Result=Initialize_HPEM_Solver(Model,varargin)
%==========================Check input=====================================
...
%========================main function=====================================
particle_num=size(Model.Mesh.particles,1);
dimension=size(Model.Mesh.particles,2);
maxdof=size(Model.Mesh.nodes,1)*dimension;
...
Result.Nfield.contact_flux=zeros(particle_num,numel(Model.Contact_condition));
%--------------------------------------------------------------------------
% Result.Pfield.U=zeros(3,1,1,particle_num);
Result.Pfield.Stress=zeros(6,1,1,particle_num);
Result.Pfield.Strain=zeros(6,1,1,particle_num);
Result.Pfield.Pstrain=zeros(6,1,1,particle_num);
Result.Pfield.Parameter=zeros(2,1,1,particle_num);
%--------------------------------------------------------------------------
